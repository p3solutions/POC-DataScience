...
public class CoreSettings implements Serializable {
	 ...
	 */
	public CoreSettings(URL urlFileName) {
		try {
	 ...
	 *            Path and file name to the .properties file to load
	 */
	public CoreSettings(String filename, String option) {
		InputStream inputStream = null;
		try {
			properties = new Properties();
			inputStream = CoreSettings.class.getResourceAsStream(filename);
	...
	public CoreSettings(String filename) {
